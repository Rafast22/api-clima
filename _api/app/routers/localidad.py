...
@router.put("/user/cultivo/localidad")
...
@router.get("/user/cultivo/localidad/{localidad_id}")
...
@router.get("/user/cultivo/localidad/cultivo/{cultivo_id}")
...
@router.get("/user/cultivo/localidad/user/{user_id}")
...
@router.delete("/user/cultivo/localidad/{localidad_id}")
...
@router.post("/user/cultivo/localidad")
...
@router.post("/user/cultivo/localidad_no_auth")
